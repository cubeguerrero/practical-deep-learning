...
def main():
    x = np.load("../data/prepared/iris_features.npy")
    y = np.load("../data/prepared/iris_labels.npy")
    N = 120
    x_train = x[:N]; x_test = x[N:]
    y_train = y[:N]; y_test = y[N:]

    xa_train = np.load("../data/prepared/iris_train_features_augmented.npy")
    ya_train = np.load("../data/prepared/iris_train_labels_augmented.npy")
    xa_test = np.load("../data/prepared/iris_test_features_augmented.npy")
    ya_test = np.load("../data/prepared/iris_test_labels_augmented.npy")
