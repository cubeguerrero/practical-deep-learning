...
xtrain = np.load("../data/prepared/iris2_train.npy")
ytrain = np.load("../data/prepared/iris2_train_labels.npy")
xtest  = np.load("../data/prepared/iris2_test.npy")
ytest  = np.load("../data/prepared/iris2_test_labels.npy")
