...
def main():
    x = np.load(os.path.join(CURRENT_DIR, "../data/prepared/iris_features.npy"))
    y = np.load(os.path.join(CURRENT_DIR, "../data/prepared/iris_labels.npy"))
    ...
    np.save(os.path.join(CURRENT_DIR, "../data/prepared/iris_train_features_augmented.npy"), newx)
    np.save(os.path.join(CURRENT_DIR, "../data/prepared/iris_train_labels_augmented.npy"), newy)
    np.save(os.path.join(CURRENT_DIR, "../data/prepared/iris_test_features_augmented.npy"), x_test)
    np.save(os.path.join(CURRENT_DIR, "../data/prepared/iris_test_labels_augmented.npy"), y_test)
